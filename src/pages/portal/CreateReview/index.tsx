...
import { countries, genderOptions, months, specialities } from "./constants";
import FormInput from "@/components/FormInput";
import FormSelect from "@/components/FormSelect";
import { useState } from "react";
import { Formik } from "formik";
import { Form } from "react-router-dom";
import { AddMedicationSchema } from "@/schema/review";
      ...
      <div className="w-full grid xl:grid-cols-2 gap-4">
        <div>
          <div className="bg-white shadow w-full p-5 my-2">
            ...
            <Divider />
            <FormInput label="Firstname" id="firstname" name="firstname" />
            <FormInput label="Lastname" id="lastname" name="lastname" />
        ...
        <div>
          ...
          <div className="flex justify-end">
            ...
            <button className="bg-primary text-white p-3">Submit Review</button>
          </div>
        </div>
      </div>
    </DashboardLayout>
